...
def init_experiment(args):
    ...
    # for ablations
    args.train_dir = f'{args.exp_root}/train/{args.dataset}/{args.method}/{args.backbone}/split:{args.split_idx}/lr:{args.LR}-batch:{args.batch_size}-transform:{args.transform}-layers:{args.layers}/seed{args.seed}/{now}'
    ...
    if args.dataset == 'cifar-10-100':
        args.train_dir = f'{args.exp_root}/train/{args.dataset}-{args.out_num}/{args.method}/{args.backbone}/split:{args.split_idx}/lr:{args.LR}-batch:{args.batch_size}-transform:{args.transform}-layers:{args.layers}/seed{args.seed}/{now}'
