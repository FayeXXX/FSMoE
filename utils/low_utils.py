...
def init_experiment(args):
    ...
    # for ablations
    args.train_dir = f'{args.exp_root}/train/{args.dataset}/{args.method}/{args.backbone}/split:{args.split_idx}/lr:{args.LR}-batch:{args.batch_size}-transform:{args.transform}-layer:{args.layers}-top_k:{args.top_k}-N_CTX:{args.N_CTX}-ss_weight:{args.ss_weight}/seed{args.seed}/{now}'
    ...
    if args.dataset == 'cifar-10-100':
        args.train_dir = f'{args.exp_root}/train/{args.dataset}-{args.out_num}/{args.method}/{args.backbone}/split:{args.split_idx}/lr:{args.LR}-batch:{args.batch_size}-transform:{args.transform}-layer:{args.layers}-top_k:{args.top_k}-N_CTX:{args.N_CTX}-ss_weight:{args.ss_weight}/seed{args.seed}/{now}'
