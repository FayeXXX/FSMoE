...
def init_experiment(args):
    ...
    # for ablations
    args.train_dir = f'{args.exp_root}/train/{args.dataset}/{args.method}/{args.backbone}/lr:{args.LR}-split:{args.split_idx}-batch:{args.batch_size}-transform:{args.transform}-orig:{args.oriweight}-clip:{args.clipweight}/seed{args.seed}/{now}'
    ...
    if args.dataset == 'cifar-10-100':
        args.train_dir = f'{args.exp_root}/train/{args.dataset}-{args.out_num}/{args.method}/{args.backbone}/lr:{args.LR}-split:{args.split_idx}-batch:{args.batch_size}-transform:{args.transform}/seed{args.seed}/{now}'
