...
class SparseMoE(nn.Module):
    ...
    def forward(self, x):
        ...
        return final_output, ori_router_output, indices
...
class PromptLearner(nn.Module):
    ...
    def forward(self, im_features):
        ...
        if len(im_features) > 1:
            ...
            bias_extra, gating_output, indices = self.moe(im_features)
        ...
        return prompts, top_feature, indices
...
class CustomCLIP(nn.Module):
    ...
    def forward(self, image, label):   # (batch_size, channels, img_size, img_size)
        ...
        prompts, top_feature, indices = self.prompt_learner(selected_features)  # (batch_size, n_cls, n_tkn, ctx_dim)
        ...
        if self.prompt_learner.training:
            ...
            return F.cross_entropy(logits, label), self.cfg.ss_weight * ss_loss, indices
